...
public class OpCode {
    ...
    public static final byte EQUAL =            0x0A;
    public static final byte GREATER =          0x0B;
    public static final byte LESS =             0x0C;
    public static final byte ADD =              0x0D;
    public static final byte SUBTRACT =         0x0E;
    public static final byte MULTIPLY =         0x0F;
    ...
    public static final byte CALL =             0x17;
    public static final byte RETURN =           0x18;
}
