...
public class OpCode {
    ...
    public static final byte GET_PROPERTY =     0x0C;
    public static final byte SET_PROPERTY =     0x0D;
    public static final byte EQUAL =            0x0E;
    public static final byte GREATER =          0x0F;
    public static final byte LESS =             0x10;
    public static final byte ADD =              0x11;
    public static final byte SUBTRACT =         0x12;
    public static final byte MULTIPLY =         0x13;
    public static final byte DIVIDE =           0x14;
    public static final byte NOT =              0x15;
    public static final byte NEGATE =           0x16;
    public static final byte PRINT =            0x17;
    public static final byte JUMP =             0x18;
