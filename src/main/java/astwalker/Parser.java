...
class Parser {
    ...
    private Expr term() {
        ...
        Expr expr = factor();
        // Se respeta el orden de preferencia de operadores, primero la suma y la resta
    ...
    private Expr factor() {
        ...
        Expr expr = unary();
        // Siguiendo el orden de preferencia, ahora van la multiplicación y la división
